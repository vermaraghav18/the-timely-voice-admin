// admin/src/components/ArticleBlockLightSettings.jsx
...
export default function ArticleBlockLightSettings() {
    ...
    (async () => {
      ...
      try {
        ...
        const next = {
          ...
          // NEW (fallback to empty arrays if missing)
  ...
  const save = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        // NEW: persist the two extra lists
      ...
      alert("Article Block Light saved!");
    } catch (e2) {
  ...
  if (loading) return <div>Loading Article Block Light…</div>;

  return (
    <form onSubmit={save} style={{ display: "grid", gap: 16 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        <h2 style={{ margin: 0 }}>Article Block Light — Settings</h2>
      ...
      {/* NEW: More World (stacked landscape) */}
      <ListEditor
...
/* -------- small inline list editor (your existing style) -------- */
